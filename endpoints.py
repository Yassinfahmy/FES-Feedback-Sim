...
# add a green circle to highlight the location of the first endpoint and name it Starting position
...
# add a red circle to highlight the location of the last endpoint and name it End position
